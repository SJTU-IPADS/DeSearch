...
{
	strncat ( (char*)pPrimary, szAddPrimary, strlen(szAddPrimary) ); // NOLINT
	strncat ( (char*)pSecondary, szAddSecondary, strlen(szAddSecondary) ); // NOLINT
}
...
void stem_dmetaphone ( BYTE * pWord )
{
	...
	strncat ( (char *) sOriginal, "          ", sizeof("          ") ); // NOLINT
